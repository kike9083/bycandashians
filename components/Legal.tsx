...
export const PrivacyPolicy: React.FC = () => {
  return (
    <div className="bg-background-dark pt-[250px] pb-24 w-full px-6 md:px-12 lg:px-24 min-h-screen">
      <div className="max-w-4xl mx-auto bg-card-dark p-10 rounded-3xl border border-white/5 shadow-2xl">
        <h1 className="text-4xl font-serif font-bold text-ivory mb-8 border-b border-gold/20 pb-4">Política de Privacidad</h1>
        <div className="prose prose-lg prose-invert text-ivory/70">
          <p className="mb-4 text-gold">Última actualización: {new Date().toLocaleDateString()}</p>

          <h3 className="text-2xl font-bold text-gold mt-8 mb-4">1. Introducción</h3>
          ...
          <h3 className="text-2xl font-bold text-gold mt-8 mb-4">2. Información que Recopilamos</h3>
          ...
          <h3 className="text-2xl font-bold text-gold mt-8 mb-4">3. Uso de la Información</h3>
          ...
          <h3 className="text-2xl font-bold text-gold mt-8 mb-4">4. Seguridad</h3>
          ...
          <h3 className="text-2xl font-bold text-gold mt-8 mb-4">5. Contacto</h3>
          <p>Si tiene preguntas sobre esta política, contáctenos en <span className="text-primary">info@tradicionpanama.com</span>.</p>
        </div>
      </div>
    </div>
  );
...
export const TermsOfService: React.FC = () => {
  return (
    <div className="bg-background-dark pt-[250px] pb-24 w-full px-6 md:px-12 lg:px-24 min-h-screen">
      <div className="max-w-4xl mx-auto bg-card-dark p-10 rounded-3xl border border-white/5 shadow-2xl">
        <h1 className="text-4xl font-serif font-bold text-ivory mb-8 border-b border-gold/20 pb-4">Términos y Condiciones</h1>
        ...
        <div className="prose prose-lg prose-invert text-ivory/70">
          ...
          <h3 className="text-2xl font-bold text-gold mt-8 mb-4">1. Reservas y Pagos</h3>
          <ul className="list-disc pl-6 mb-4 space-y-2 marker:text-gold">
          ...
          <h3 className="text-2xl font-bold text-gold mt-8 mb-4">2. Uso y Cuidado de la Indumentaria</h3>
          <ul className="list-disc pl-6 mb-4 space-y-2 marker:text-gold">
          ...
          <h3 className="text-2xl font-bold text-gold mt-8 mb-4">3. Cancelaciones y Devoluciones</h3>
          <ul className="list-disc pl-6 mb-4 space-y-2 marker:text-gold">
          ...
          <h3 className="text-2xl font-bold text-gold mt-8 mb-4">4. Tiempos de Alquiler</h3>
